...
export const MachineStart = () => {
        ...
        return (
            <div className="flex-1 flex flex-col items-center justify-center p-10 text-center animate-in fade-in zoom-in duration-300 relative">
                ...
                <div className="p-8 bg-white rounded-3xl shadow-xl mb-8">
                    <QRCode value="https://react-portfolio-flame-delta.vercel.app/" size={256} />
                </div>
    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-10 text-center space-y-10 animate-in fade-in duration-700">
            <div className="space-y-4">
                <h1 className="text-6xl font-black bg-gradient-to-b from-white to-gray-500 bg-clip-text text-transparent">
                    Start Recycling
                </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                <div
                    ...
                    className="bg-gray-900/50 border border-gray-800 p-10 rounded-3xl flex flex-col items-center gap-6 hover:bg-gray-800/80 transition-colors cursor-pointer group"
                >
                    <div className="p-6 bg-green-500/20 rounded-full text-green-500 group-hover:scale-110 transition-transform">
                        <QrCode className="w-16 h-16" />
                    </div>
                    <div className="text-center">
                        <h3 className="text-2xl font-bold mb-2">Scan App QR</h3>
                        <p className="text-gray-400">Get the Reality-X App</p>
                    </div>
                </div>

                <Link to="/deposit" className="bg-white text-black border border-white p-10 rounded-3xl flex flex-col items-center gap-6 hover:bg-gray-200 transition-colors cursor-pointer group">
                    <div className="p-6 bg-black/10 rounded-full text-black group-hover:scale-110 transition-transform">
                        <ArrowRight className="w-16 h-16" />
                    </div>
                    <div className="text-center">
                        <h3 className="text-2xl font-bold mb-2">Deposit Waste</h3>
                        <p className="text-gray-600">Start recycling immediately</p>
                    </div>
                </Link>
            </div>
