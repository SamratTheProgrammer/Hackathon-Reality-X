...
import { MapPin, Server, Shield, CheckCircle, ArrowRight } from "lucide-react";
...
export const MachineSignup = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.machineId || !formData.password || !formData.location) {
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-center animate-in fade-in zoom-in duration-500">
                <div className="bg-green-500/20 p-6 rounded-full text-green-500 mb-6">
        ...
        <div className="min-h-screen bg-black flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 p-10 lg:p-20 flex flex-col justify-center bg-gray-900 border-r border-gray-800">
                ...
                <div className="space-y-6">
                    {[
                        { icon: Server, title: "Secure Identity", desc: "Unique cryptographic ID for every machine." },
                        { icon: MapPin, title: "Geo-Location", desc: "Precise tracking for user discovery." },
                        { icon: Shield, title: "Tamper Proof", desc: "Encrypted transaction logs." }
                    ].map((item, i) => (
                ...
                <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-500 mb-1">Capacity (Items)</label>
                                <input
                                    type="number"
                                    name="capacity"
